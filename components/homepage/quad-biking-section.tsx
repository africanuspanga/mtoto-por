        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-balance">
              Experience Quad Biking in Zanzibar
            </h2>
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              Feel the thrill of adventure as you ride through Zanzibar's stunning landscapes on a powerful quad bike.
              Explore hidden trails, coastal paths, and rural villages while experiencing the island from a completely
              new perspective.
            </p>
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-center gap-3 text-foreground">
                <span className="h-2 w-2 bg-primary rounded-full" />
                Scenic routes through beaches, forests, and villages
              </li>
              <li className="flex items-center gap-3 text-foreground">
                <span className="h-2 w-2 bg-primary rounded-full" />
